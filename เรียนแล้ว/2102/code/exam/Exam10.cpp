...
class Person{
    ...
    public:
        ...
        virtual void showOperator(ostream &os){
        ...
        virtual void setOperator(istream &is){
            cout << "fname : "; is >> fname;
            cout << " lname : "; is >> lname;
...
class TeachingAssistant:public Student, public Teacher{
    ...
    public:
        ...
        void showTa(){
            ...
            cout << "Position : " << Teacher::getPosition() << endl << endl;
        ...
        TeachingAssistant& operator=(TeachingAssistant &ta){
            ...
            // Teacher::operator=(ta);
            setTeacherId(ta.getTeacherId());
            setSubject(ta.getSubject());
            setPosition(ta.getPosition());
        ...
        void showOperator(ostream &os){
            ...
            Student::showOperator(os);
            // Teacher::showTeacher(os);
            os << "Teacher Id : " << getTeacherId() << endl;
            os << "subject  : " << getSubject() << endl;
            os << "position : " << getPosition() << endl<< endl;
        ...
        void setOperator(istream &is){
            // Person::setPerson(is);
            Student::setOperator(is);
            // Teacher::setTeacher(is);
            string teacherIDTemp, subjectTemp;
            char positionTemp[20];
            cout << "Teacher Id : " << endl;    is >> teacherIDTemp;
            setTeacherId(teacherIDTemp);
            cout << "subject : " << endl; is >> subjectTemp;
            setSubject(subjectTemp);
            cout << "position : " << endl; is >> positionTemp;
...
ostream& operator<<(ostream& os,Person &ta){
    ta.showOperator(os);
    return os;
}

istream& operator>>(istream& is, Person &ta){
    ta.setOperator(is);
    return is;
}
...
int main(){
    ...
    // p1 = p2;
    // p1.show();
    // cout << "------------ end person ------------" << endl << endl;


    cout << "------------ start student ------------" << endl;
    Student s1;
    cin >> s1;
    cout << s1;
    ...
    // cout << "------------ start teacher ------------" << endl;
    // Teacher t1;
    // cin >> t1;
    // cout << t1;
    // cout << "------------ end t1 ------------" << endl << endl;
    // cout << "------------ t2 ------------" << endl;
    // Teacher t2(t1);
    // t2.show();
    // t1 = t2;
    // t1.show();
    // cout << "------------ end teacher ------------" << endl << endl;


    // cout << "------------ start     TeachingAssistant ta1 ------------" << endl;
    // TeachingAssistant ta1;
    // cin >> ta1;
    // cout << ta1;
    // cout << "------------ end ta1 ------------" << endl << endl;
    // cout << "------------ ta2 ------------" << endl;
    // TeachingAssistant ta2(ta1);
    // cout << " print ta2 : " << ta2 << endl;
    // ta1 = ta2;
    // cout << " print ta1 : " << ta1 << endl;
    // cout << "------------ end TeachingAssistant ------------" << endl << endl;
