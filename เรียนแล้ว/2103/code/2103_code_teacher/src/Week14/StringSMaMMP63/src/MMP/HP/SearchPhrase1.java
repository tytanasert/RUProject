...
//   int counttemp =0;
   ...
   PreprocessingPhrase64 pattern;
    /** Creates a new instance of SearchPhrase */
    public SearchPhrase1() {
      pattern = new PreprocessingPhrase64();  // ���ҧ pattern ��ѡ�ͧ����ѡ��� 52 ���
    }
...
//            pattern.ShowdTable();
//            System.out.println("end data table");
...
//                java.sql.Connection conn=a.DBConnect(my.MyUrl()+"/Thesis", my.MyUser(), my.MyPassWord());        
         ...
         ///        for(int i=0;i<7;i++){
           ...
           { 
              ...
              // System.out.println("pos="+pos+"text pos:"+text[pos]);
              // System.out.println("case Node:"+caseNode(text[pos]));
