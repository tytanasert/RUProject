...
public class LinkedList extends javax.swing.JFrame {
    ...
    private void insert(int id, int point){
        ...
        NodeA.ID = id;
        NodeA.POINT = point;
        NodeA.GRADE = calGrade(point);
        
        Node PTR = START;
        if(START == null){
            START = new Node();
            LAST = new Node();
//            NodeA.LINK = START.LINK;
            START.LINK = NodeA;
            LAST.BACK = NodeA;
        }else if(START.LINK.ID == id){
            //dup id
        }
        else if(START.LINK.ID > id){
            //insert first node
            NodeA.LINK = START.LINK;
            START.LINK.BACK = NodeA;
            START.LINK = NodeA;
        }else{
            while(PTR.LINK != null){
                Node PTR2 = PTR.LINK;
            ...
            if(PTR.LINK == null){
               //insert last node
                NodeA.BACK = LAST.BACK;
                LAST.BACK = NodeA;
                (NodeA.BACK).LINK = NodeA; 
            }
        }
        showData();
    ...
    private void showData(){
        model.setRowCount(0);
        if(START == null){
            System.out.println("showData : START == null");
            return;
        }
        Node PTR = START.LINK;
        while(PTR != null){
    ...
    private void search(int id){
        ...
        while(PTR != null){
            if(PTR.ID == id){
                jLabel6.setText("Point : " + PTR.POINT + "\n" + " , Grade : " + PTR.GRADE);
                break;
            }
            PTR = PTR.LINK;
        }
