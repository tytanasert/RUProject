 ...
 * @author ty
 */
public class QueueCircle extends javax.swing.JFrame {

    int FRONT = -1, REAR = -1, ITEM, N = 10;
    String QUEUEids[] = new String[10];
    int QUEUE[] = new int[10];
    int count = 0, sum =0;

    public QueueCircle(int size) {
        QUEUE = new int[size];
        N = size - 1;
    }
...
//    return true;
    ...
    public void showDatainQueue() {
        jTextField7.setText(QUEUE.length > 0 && QUEUE[0] > 0 ? QUEUE[0] + "" : "");
        jTextField8.setText(QUEUE.length > 1 && QUEUE[1] > 0 ? QUEUE[1] + "" : "");
        jTextField9.setText(QUEUE.length > 2 && QUEUE[2] > 0 ? QUEUE[2] + "" : "");
        jTextField10.setText(QUEUE.length > 3 && QUEUE[3] > 0 ? QUEUE[3] + "" : "");
        jTextField11.setText(QUEUE.length > 4 && QUEUE[4] > 0 ? QUEUE[4] + "" : "");
        jTextField12.setText(QUEUE.length > 5 && QUEUE[5] > 0 ? QUEUE[5] + "" : "");
        jTextField13.setText(QUEUE.length > 6 && QUEUE[6] > 0 ? QUEUE[6] + "" : "");
        jTextField14.setText(QUEUE.length > 7 && QUEUE[7] > 0 ? QUEUE[7] + "" : "");
        jTextField15.setText(QUEUE.length > 8 && QUEUE[8] > 0 ? QUEUE[8] + "" : "");
        jTextField16.setText(QUEUE.length > 9 && QUEUE[9] > 0 ? QUEUE[9] + "" : "");
    ...
    private void setBgGray(int id){
        ...
        switch(id){
            case 0: jTextField7.setBackground(color);break;
            case 1: jTextField8.setBackground(color);break;
            case 2: jTextField9.setBackground(color);break;
            case 3: jTextField10.setBackground(color);break;
            case 4: jTextField11.setBackground(color);break;
            case 5: jTextField12.setBackground(color);break;
            case 6: jTextField13.setBackground(color);break;
            case 7: jTextField14.setBackground(color);break;
            case 8: jTextField15.setBackground(color);break;
            case 9: jTextField16.setBackground(color);break;
            default : break;   
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QueueCircle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QueueCircle().setVisible(true);
            }
        });
